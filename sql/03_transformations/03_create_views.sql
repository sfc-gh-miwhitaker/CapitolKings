...
COMMENT = 'DEMO: credit-portfolio - Current portfolio positions with latest metrics'
AS
SELECT
...
COMMENT = 'DEMO: credit-portfolio - Deals on watchlist or intensive care status'
AS
SELECT
    deals.deal_name,
    companies.company_name,
...
COMMENT = 'DEMO: credit-portfolio - Month-end portfolio metrics for trend analysis'
AS
SELECT
